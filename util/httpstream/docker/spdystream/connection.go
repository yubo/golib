...
import (
	...
	"github.com/yubo/golib/util/httpstream/docker/spdystream/spdy"
)
...
Loop:
	for {
		...
		case <-i.conn.closeChan:
			...
			// deadlock.
			//
			// See https://github.com/yubo/golib/util/httpstream/docker/spdystream/issues/49 for more details.
			go func() {
...
type Connection struct {
	...
	// for testing https://github.com/yubo/golib/util/httpstream/docker/spdystream/pull/56
