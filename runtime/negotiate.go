...
func (n *clientNegotiator) Encoder(contentType string, params map[string]string) (Encoder, error) {
	...
	return n.serializer.EncoderForVersion(info.Serializer), nil
}
...
func (n *clientNegotiator) Decoder(contentType string, params map[string]string) (Decoder, error) {
	...
	return n.serializer.DecoderToVersion(info.Serializer), nil
}
...
func (n *clientNegotiator) StreamDecoder(contentType string, params map[string]string) (Decoder, Serializer, Framer, error) {
	...
	return n.serializer.DecoderToVersion(info.Serializer), info.StreamSerializer.Serializer, info.StreamSerializer.Framer, nil
}
...
func (n *simpleNegotiatedSerializer) EncoderForVersion(e Encoder) Encoder {
	return e
}

func (n *simpleNegotiatedSerializer) DecoderToVersion(d Decoder) Decoder {
	return d
}
