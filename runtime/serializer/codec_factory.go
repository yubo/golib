...
func NewCodecFactory(mutators ...CodecFactoryOptionsMutator) CodecFactory {
	...
	serializers := newSerializersForScheme(options)
	return newCodecFactory(serializers)
}
...
func (f CodecFactory) LegacyCodec() runtime.Codec {
	return versioning.NewDefaultingCodecForScheme(f.legacySerializer, f.universal)
}
...
func (f CodecFactory) UniversalDecoder() runtime.Decoder {
	return f.CodecForVersions(nil, f.universal)
}

// CodecForVersions creates a codec with the provided serializer. If an object is decoded and its group is not in the list,
// it will default to runtime.APIVersionInternal. If encode is not specified for an object's group, the object is not
// converted. If encode or decode are nil, no conversion is performed.
func (f CodecFactory) CodecForVersions(encoder runtime.Encoder, decoder runtime.Decoder) runtime.Codec {
	return versioning.NewDefaultingCodecForScheme(encoder, decoder)
}

// DecoderToVersion returns a decoder that targets the provided group version.
func (f CodecFactory) DecoderToVersion(decoder runtime.Decoder) runtime.Decoder {
	return f.CodecForVersions(nil, decoder)
}

// EncoderForVersion returns an encoder that targets the provided group version.
func (f CodecFactory) EncoderForVersion(encoder runtime.Encoder) runtime.Encoder {
	return f.CodecForVersions(encoder, nil)
}
