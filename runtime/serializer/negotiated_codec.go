...
func (n *negotiatedSerializerWrapper) EncoderForVersion(e runtime.Encoder) runtime.Encoder {
	return e
}

func (n *negotiatedSerializerWrapper) DecoderToVersion(d runtime.Decoder) runtime.Decoder {
	return d
}
