...
import (
	...
	"github.com/yubo/golib/staging/logs/sanitization"
	"k8s.io/klog/v2"
)
...
// List of logs (k8s.io/klog + github.com/yubo/golib/staging/logs) flags supported by all logging formats
...
func unsupportedLoggingFlags() []string {
	...
	// github.com/yubo/golib/staging/logs flags
	pfs := &pflag.FlagSet{}
	AddFlags(pfs)
